...
$product=$book->search($id);
foreach($product as $v){
	$sameCat=$book->sameCat($v['cat_id']);
}
													...
													?>
                                                        <div class="col-xs-12 col-sm-12 col-md-4 col-lg-4">
                                                            <div class="tg-postbook">
                                                                <figure class="tg-featureimg"><img style="min-width: 146px;min-height:206px;"
                                                                        src="images/book/<?php echo $item['img']?>"
                                                                ...
                                                                <div class="tg-postbookcontent">
                                                                        ...
                                                                        if($item['SALE']!=null){
                                                                            ?>
                                                                                <span class="tg-bookwriter">You save
                                                                                    <?php
                                                                                            echo ($item['price']/1000)-($item['SALE']/1000);
                                                                                    ?>K
                                                                                </span>
                                                                            <?php
                                                                        }
                                                                    ...
                                                                    <ul class="tg-delevrystock">
                                                                        <li><i class="icon-rocket"></i><span>Free delivery
                                                                                worldwide</span></li>
                                                                        <li><i class="icon-checkmark-circle"></i><span>Dispatch from
                                                                                the USA in 2 working days </span></li>
                                                                        <li><i class="icon-store"></i><span>Status: <em>In
                                                                                    Stock</em></span></li>
                                                                    </ul>
                                                                    <div class="tg-quantityholder">
                                                                        <em class="minus">-</em>
                                                                        <input type="number" class="result" value="1" id="quantity1"
                                                                            name="quantity" min='1'>
                                                                        <em class="plus">+</em>
                                                                    </div>
                                                                    <a class="tg-btn tg-active tg-btn-lg add-cart" href="javascript:void(0);">
                                                                        Add To Basket
                                                                    </a>
                                                        ...
                                                        <div class="col-xs-12 col-sm-12 col-md-8 col-lg-8">
                                                            <div class="tg-productcontent">
                                                                ...
                                                                <span class="tg-bookwriter">Publisher: <a
                                                                        href="javascript:void(0);">
                                                                        <?php
                                                                            foreach($dataPub as $pub){
                                                                                if($pub['pub_id']==$feat['pub_id']){
                                                                ...
                                                                <span class="tg-stars"><span></span></span>
                                                                <span class="tg-addreviews"><a href="javascript:void(0);">Add Your
                                                                        Review</a></span>
                                                                <div class="tg-share">
                                                                    <span>Share:</span>
                                                                ...
                                                                <ul class="tg-productinfo">
                                                                    ...
                                                                    <li><span>Pages:</span><span><?php echo $item['pages']?></span>
                                                                    </li>
                                                                    <li><span>Dimensions:</span><span>153 x 234 x 43mm | 758g</span>
                                                                    </li>
                                                                    <li><span>Date Added:</span><span><?php echo strtoupper(date("j M Y",strtotime($item['DATEADDED'])));?></span>
                                                                    </li>
                                                                    <li><span>Publisher:</span><span>
                                                                        <?php
                                                                            foreach($dataPub as $pub){
                                                                                if($pub['pub_id']==$feat['pub_id']){
                                                                                    echo $pub['pub_name'];
                                                                    ...
                                                                    <li><span>Illustrations note:</span><span>b&amp;w images
                                                                            thru-out; 1 x 16pp colour plates</span></li>
                                                                    <li><span>ISBN10:</span><span>1234567890</span></li>
                                                                    <li><span>ISBN13:</span><span>1234567890000</span></li>
                                                                    <li><span>Other Fomate:</span><span>CD-Audio, Paperback,
                                                                            E-Book</span></li>
                                                                </ul>
                                            ...
                                            <div class="tg-relatedproducts">
                                                ...
                                                <div class="col-xs-12 col-sm-12 col-md-12 col-lg-12">
                                                    <div id="tg-relatedproductslider"
                                                        ...
                                                        <?php
															foreach($sameCat as $relatedItems){
																?>
																	<div class="item">
																		<div class="tg-postbook">
																			<figure class="tg-featureimg">
																				<div class="tg-bookimg">
																					<div class="tg-frontcover"><img
																							src="images/book/<?php echo $relatedItems['img']?>"
																			...
																			<div class="tg-postbookcontent">
																				<ul class="tg-bookscategories">
																					...
																					<?php
																						foreach($dataCat as $cat){
																							if($cat['cat_id']==$relatedItems['cat_id']){
																								echo $cat['cat_name'];
																							}
																						}
																					?>
																				...
																				<?php
                                                                                    $newbook=false;
                                                                                    foreach($dataNew as $new){
                                                                                        if($new['book_id']==$relatedItems['book_id']){
                                                                                            $newbook=true;
                                                                                        }
                                                                                    }
                                                                                    if($relatedItems['FEATURED']=='yes'||$relatedItems['SALE']!=null||$newbook==true){
                                                                                        ?>
                                                                                            <div class="tg-themetagbox"><span class="tg-themetag">
                                                                                                <?php
                                                                                                    $stat='';
                                                                                                    if($relatedItems['FEATURED']=='yes'){
                                                                                                        if($stat==''){
                                                                                                            $stat.=" featured";
                                                                                                        }else{
                                                                                                            $stat.=" & featured";
                                                                                ...
                                                                                ?>
																				<div class="tg-booktitle">
																					<h3><a href="productdetail?id=<?php echo $relatedItems['book_id']?>">
																						<?php echo $relatedItems['book_name']?>
																					</a></h3>
																				</div>
																				<span class="tg-bookwriter">Publisher:
																					<a href="javascript:void(0);">
																					<?php
																						foreach($dataPub as $pub){
																							if($pub['pub_id']==$relatedItems['pub_id']){
																								echo $pub['pub_name'];
																							}
																						}
																					?>
                                                                                ...
                                                                                <?php
                                                                                    if($relatedItems['SALE']!=null){
                                                                                        ?>
                                                                                        <ins>
                                                                                            <?php echo ($relatedItems['SALE']/1000)?>K VND
                                                                                        </ins>
                                                                                        <del>
                                                                                            <?php echo ($relatedItems['price']/1000)?>K VND
                                                                                        </del>
                                                                                        <?php
                                                                                    }
                                                                                    else{
																				...
																				<a class="tg-btn tg-btnstyletwo add-cart"
																					href="javascript:void(0);">
																					<i class="fa fa-shopping-basket "></i>
																					<em>Add To Basket</em>
																				</a>
																				<div class="id" style="display:none;"><?php echo $relatedItems['book_id']?></div>
																			</div>
																		</div>
																	</div>
                                                        		<?php
	...
	*************************************-->
    ...
    $(document).ready(function() {
        $('.add-cart').click(function() {
            var a = $(this).parent().find('div[class=id]').html();
			var c="<?php echo $id?>"
			if(a!=c){
				var b=1;
			}else{
            ...
            if(b<0){
                alert("Cannot order a negative amount!");
                exit;
            }else if(b==0){
                exit;
            }
